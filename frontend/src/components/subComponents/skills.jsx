...
import { Card, CardContent, CardHeader, CardMedia, Collapse, Divider, Grid } from '@material-ui/core';
    ...
    function renderCardContent(skillName, skillIcon, linuxFlag) {
        ...
        return (
            <CardContent className="cardContentItem">
                <img src={skillIcon} alt={skillName} width={checkPictureDimension()} height={checkPictureDimension()}></img>
